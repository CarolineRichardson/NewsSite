...
from news_app.views import register,welcome,brickout, create, articles, article, loggedIn, logout, main, about
...
urlpatterns = patterns('',
    ...
    url(r'^articles/', include('news_app.urls')),
    url(r'^messages/', include('news_app.urls')),
